...
## Summary of findings 
* The mean Norwegian electricity spot price is projected to be 54.23 €/MWh from today until 2030. 
* A 50% increase until 2030 in variable renewable energy production in countries with an oversea connection, the mean price will be 50.43 €/MWh, 7% lower than the base scenario.
* A 10% increase until 2030 in domestic consumption the mean price will be 59.67 €/MWh, 10.04% higher than the base scenario. 
* An increase in both variable renewable energy and consumption, the mean price will be 55.87 €/MWh, 3.03% lower than the base scenario.  
