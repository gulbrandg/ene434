...
For exchange it is difficult to pinpoint any exact relation to price. High export (negative exchange) and import (positive exchange) seems to give higher prices then small export and small import. Additionally, different time periods for when the exchange occurred seem to display different relations to price. The difficulty of determining this relationship calls for more complex methods, which we will later
